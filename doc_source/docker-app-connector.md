...
**Note**  
The maximum size of a shadow document is 8 KB\. For more information, see [AWS IoT Limits](https://docs.aws.amazon.com/iot/latest/developerguide/limits-iot.html) in the *AWS IoT Developer Guide*\.
