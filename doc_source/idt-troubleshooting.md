...
|  128  |  OTAJobNotSuccededError  |  The OTA job did not succeed\.  |  Check your internet connectivity and retry the OTA test group\. If the problem persists, contact [AWS Developer Support](https://aws.amazon.com/premiumsupport/plans/developers/)\.  | 
